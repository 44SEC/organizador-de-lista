...
$bubblesort_script_runtime = ($bubblesort_script_output -split "`n" | Where-Object { $_ -match "O programa levou" }) -replace "^\[\!\] "
...
$mergesort_script_runtime = ($mergesort_script_output -split "`n" | Where-Object { $_ -match "O programa levou" }) -replace "^\[\!\] "
...
$quicksort_script_runtime = ($quicksort_script_output -split "`n" | Where-Object { $_ -match "O programa levou" }) -replace "^\[\!\] "
